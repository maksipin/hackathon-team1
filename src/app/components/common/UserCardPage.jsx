...
import vk from "../../components/page/userPage/userPageSocialSvg/vk.svg";
import tg from "../../components/page/userPage/userPageSocialSvg/tg.svg";
import git from "../../components/page/userPage/userPageSocialSvg/git.svg";
import ProgressBar from "./ProgressBar";

const UserCardPage = ({ img, name, age, badge, description, skils }) => {
    return (
